...
- [x] **ADS-02**: Live fleet map view shows all of the school's aircraft (matched by tail number) with current position, altitude, speed, heading, and last-update age, sourced from FAA SWIM SCDS via the ADS-B Tracker
